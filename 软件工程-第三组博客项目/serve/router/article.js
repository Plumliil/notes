...
// getArticlesFront
// 获取文章列表
// router.get('/front',articleCtrl.getArticlesFront);
// 获取用户关注的作者文章列表
router.get('/feed',articleCtrl.getFeedArticles)
// 获取文章
router.get('/:articleId',articleValidator.getArtcle,articleCtrl.getArticle)
// 创建文章
...
// 获取用户文章
router.get('/user/:userId',articleCtrl.getUserArticle)
